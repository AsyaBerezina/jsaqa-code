...
describe("Бронирование билета в зале из админки", () => {
  it("читает название зала в админке и проходит сценарий бронирования на клиенте", () => {
    ...
    cy.get(`${hallControl.section} ${hallControl.hallNameButton}`).then(
      ($buttons) => {
        ...
        // Перебираем все залы из админки: у первого в списке может не быть сеансов в сетке
